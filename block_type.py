...
class Block_type:
	...
	def __init__(self, texture_manager, name="unknown", block_face_textures={"all": "cobblestone"}, model=models.cube, hardness=0.0, sound="stone", is_sprite=False, sprite_path=None, light_level=0):
		self.name = name
